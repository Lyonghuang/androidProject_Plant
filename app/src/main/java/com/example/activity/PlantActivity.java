...
//                break;
//            case 4:
//                bitmap= BitmapFactory.decodeResource(getResources(),R.drawable.plant4);//君子兰
//                break;
//            case 5:
...
//        plant_detail_img.setImageBitmap(bitmap);
        Glide.with(this).load(imgId).into(plant_detail_img);
        ...
        detail_name.setmOnLSettingItemClick(new LSettingItem.OnLSettingItemClick() {
            ...
            public void click() {
                ...
                intent.putExtra("activity","plantActivity");
